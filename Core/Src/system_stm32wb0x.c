...
void SystemInit(void)
{
  ...
  {
	// Исправление бага часов: при подаче питания часы не могут запустится,
	// но после ресета нормально стартуют - при обнаружении PowerOn -
	// начинаем запуск часов и сразу перезагружаемся
